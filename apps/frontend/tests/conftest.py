...
def analytics_cell(
    *,
    ...
    delta: float,
    dollar_delta: float,
    surface_side: str = tables.SURFACE_SIDE_COMBINED,
    ...
    return tables.ProjectedOptionAnalytics(
        ...
        total_variance=implied_vol * implied_vol * maturity_years,
        price=AN_PRICE,
        delta=delta,
        gamma=0.02,
        vega=0.31,
        ...
        provenance=prov(f"analytics:{surface_side}:{maturity_years:g}:{delta_band}"),
