...
export function BacktestResults({
  ...
  return (
    <Stack className="backtest-results" gap="md">
      <article className="panel" aria-label="Backtest summary">
        <Stack gap="md">
          ...
          <p>
            ...
            <strong>max drawdown</strong> is the worst peak-to-trough dip;{" "}
            <strong>worst stress</strong> is the deepest loss across the what-if shock grid.
          </p>
          <div className="quote-strip">
            ...
            <Metric
              ...
              value={sciUnit(summary.total_transaction_cost, moneyUnit)}
            />
            ...
            <Metric
              ...
              value={sciUnit(summary.worst_stress_loss, moneyUnit)}
            />
          </div>
        </Stack>
      </article>
