...
changed" without pretending the scenario grid changed too.
...
section's hash moves. Runtime/environment settings such as the storage path are
deliberately *not* in here: they are environment, not economics, and must not
