...
and derives the implied carry/dividend, returning a rich :class:`ForwardEstimate`.
:func:`forward_curve_point` projects the usable part into A's stamped
``ForwardCurvePoint`` contract. The parity math lives in :mod:`forwards.parity`.

    from forwards import estimate_forward, ForwardPair, forward_curve_point
"""
