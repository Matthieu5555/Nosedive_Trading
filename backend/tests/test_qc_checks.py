...
the specificity assertion is the load-bearing one.
...
are built by qc-test-owned helpers below, never by editing ``src/fixtures``.
"""
...
from contracts import MarketStateSnapshot, QcResult
...
from pricing import PriceGreeks
from qc import (
    SEVERITY_CRITICAL,
    SEVERITY_WARNING,
    STATUS_FAIL,
...
from risk import BrokerGreeks, ContractValuationInput, PositionRisk, position_risk
from snapshots import AssessedSnapshot, QuoteAssessment, SnapshotBatch
