...
from risk import greeks as greeks_mod
from risk import scenario as scenario_mod
...
def test_persisted_scenario_version_moves_with_grid_construction_constants() -> None:
    # The headline reproducibility guarantee: changing a D-owned grid-construction
    # constant (the roll-down set or the crash rule) must move the persisted version,
    # so two different grids can never share one scenario_version.
