// Typed client for the BFF. Response shapes mirror backend/src/frontend/serializers.py;
// keep them in sync when a serializer changes (the HTTP contract is the seam).
