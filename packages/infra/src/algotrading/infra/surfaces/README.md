...
(ADR 0050), a vega comparable across tenors — in the same dual, unit-tagged representation.
...
ADR 0050) and the two convention forks (gamma per 1% vs $1, theta ÷365 vs ÷252) come from
