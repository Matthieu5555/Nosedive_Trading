...
6. **F-SURF-01 — projection discount-factor silently falls back to DF=1.0** (`projection.py:251-253`, drift). Pinned-tenor keys never match listed-expiry keys → every projected cell priced as if rates were zero, no flag.
