...
- ~~[platform-intent-vs-delivery-audit](platform-intent-vs-delivery-audit.md)~~ **done 2026-06-16** — findings in [T-intent-vs-delivery-audit-findings-2026-06-16](T-intent-vs-delivery-audit-findings-2026-06-16.md). 7 confirmed (F1 latent nearest-N regression `38910d9` re-opened the tenor seed; F2 long-end QC floor mis-calibrated vs LEAP two-sided liquidity; F3 surface_fit measured_value; F4 forward cap; F5 scenario clip; F6 ADR-0028 literals; F7 storage re-capture visibility) + 2 overturned false positives. Verified on the 2026-06-16 partitions (gateway unset). Remediation tasks named in the report. · [platform-post-monday-restore-cleanup](platform-post-monday-restore-cleanup.md) (one-shot — purge the Friday-restore run-state ledger AFTER Monday 2026-06-15 close is captured + validated)
